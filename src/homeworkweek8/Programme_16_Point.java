...
public class Programme_16_Point {
    ...
    public Programme_16_Point() {
        // No-arg constructor, initializes both x and y to 0.
        this(0, 0);
    }
    ...
    public double distance() {
        // Calculate the distance between this Point and Point 0,0.
        return Math.sqrt(x * x + y * y);
    }

    public double distance(int x, int y) {
        // Calculate the distance between this Point and Point (x, y).
        int xDiff = this.x - x;
        int yDiff = this.y - y;
