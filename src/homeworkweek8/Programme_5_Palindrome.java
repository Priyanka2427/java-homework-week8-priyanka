 ...
 * Tip: Be careful with reversing a number, you will need a parameter for comparing a reversed numberwith the starting number (parameter).
...
public class Programme_5_Palindrome {
    ...
    public static boolean isPalindrome(int number) {
        ...
        // Compare the reverser number with the original number
